...
class GcodeReader:
    ...
    def plot(self, low_layer, high_layer):
        ...
        fig, ax = create_fig_axis((8, 8), '3d')

        # ... (code for plotting the part) ...

        ax.view_init(elev=30, azim=45)  # Set perspective
    ...
    def mesh(self, low_layer, high_layer):
        ...
        # ... (code for plotting the mesh) ...

        ax.view_init(elev=60, azim=135)  # Set perspective
